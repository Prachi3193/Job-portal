  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
        ...
        <div className='my-4'>
            ...
            <h1 className='font-bold my-1 '>Experience: <span className='py-4 font-normal text-gray-800'>{singleJob?.experience} years</span></h1>
            <h1 className='font-bold my-1 '>Salary: <span className='py-4 font-normal text-gray-800'>{singleJob?.salary} LPA</span></h1>
            <h1 className='font-bold my-1 '>Total Applicants: <span className='py-4 font-normal text-gray-800'></span>{singleJob?.applications?.length}</h1>
            <h1 className='font-bold my-1 '>Posted Date: <span className='py-4 font-normal text-gray-800'>{singleJob?.craetedAt.split("T")[0]}</span></h1>
        </div>
    </div>
  )
}
